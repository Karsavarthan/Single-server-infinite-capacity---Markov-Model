...
The mean service rate per second : 0.17 
Average number of objects in the system : 0.86 
Average number of objects in the conveyor :  0.40 
Average waiting time of an object in the system : 11.14 secs
Average waiting time of an object in the conveyor : 5.14 secs
Probability that the system is busy : 0.46 
Probability that the system is empty : 0.54 
---------------------------------------------------------------
```
